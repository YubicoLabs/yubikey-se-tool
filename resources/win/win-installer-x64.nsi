...
!else
  ...
  !system "$\"${NSISDIR}\makensis$\" /DVERSION=${VERSION} /DINNER win-installer-x64.nsi" = 0
  ...
  ; The file to write
  OutFile "../../yubikey-se-tool-qt-${VERSION}-win64.exe"
  
  ; The default installation directory
  InstallDir "$PROGRAMFILES64\Yubico\YubiKey SE Tool"
